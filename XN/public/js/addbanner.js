...
$(function () {
    ...
    submit.on('click', function () {
        ...
        $.ajax({
            url: '/teadao/index.php/hthome/addbanners',
            data: data,
            processData: false,
            contentType: false,
            method: 'post',
            success: function success(data) {
                if (data == 'ok') {
                    location.href = '/teadao/index.php/hthome/banner';
                } else if (data == 'error') {
                    alert('添加失败');
                }
            }
    ...
    ///////////////////////上传图片//////////////////////////
    var upload = document.querySelector('#bimg');
    var image = document.querySelector('#bimage');
